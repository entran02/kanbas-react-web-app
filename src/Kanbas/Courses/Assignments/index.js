    ...
    <div style={{ paddingTop: "15px" }}>
      <div className="row">
        ...
        <div className="col-auto float-end" style={{ marginBottom: "-30px" }}>
          ...
          <Link to={`/Kanbas/Courses/${courseId}/Assignments/new`}>
            <button className="btn btn-danger" onClick={handleNew}>
              + Assignment
            </button>
          </Link>
      ...
      <div className="col">
        <ul
          ...
          style={{ borderRadius: "0", width: "930px", overflow: "auto" }}
        >
          ...
          {courseAssignments.map((assignment) => (
            <li
              className="list-group-item py-3 d-flex"
            ...
            >
              ...
              <div className="col-9">
                ...
                <div>
                  <small className="text-secondary">Missing description</small>
                </div>
              </div>
              <div
              ...
              >
                ...
                ></i>
                <i
                  className="fas fa-ellipsis-v me-3"
                  style={{ color: "gray" }}
                ></i>
                <button
                  className="float-end btn btn-danger"
                  onClick={(e) => {
                    handleDelete(e, assignment._id, assignment.title);
                  }}
                >
                  Delete
                </button>
